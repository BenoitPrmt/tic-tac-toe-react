...
import {GameContextType} from "../types/GameContext.ts";
...
export const GameProvider = ({children}: { children: ReactNode }) => {
    ...
    }, [playerOneUsername, playerOneScore, playerTwoUsername, playerTwoScore, draws, isGameAgainstComputer, isGame3Shots, currentPlayer]);
